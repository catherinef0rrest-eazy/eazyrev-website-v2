                ...
                <CardContent className="p-0">
                  ...
                  <div className="relative">
                    <Button 
                      ...
                      className="w-full bg-slate-900 hover:bg-slate-800 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-200 shadow-sm professional-btn"
                    >
