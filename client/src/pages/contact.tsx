...
export default function Contact() {
  return (
    <div className="landing-backdrop">
      <div className="landing-content max-w-4xl mx-auto px-4 sm:px-6 pt-20 pb-16 page-transition flex flex-col items-center">
        ...
        <Card className="metric-card rounded-2xl p-4 sm:p-6 enterprise-shadow-lg card-hover-effect w-full max-w-4xl">
