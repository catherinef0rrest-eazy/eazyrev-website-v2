    ...
    <div className="landing-backdrop">
      <div className="landing-content max-w-5xl mx-auto px-4 sm:px-6 pt-20 pb-16 page-transition overflow-hidden">
        ...
        <div className="text-center mb-20 slide-up">
          ...
          <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-slate-900 tracking-tight leading-tight px-2">
            Bespoke Sales Insights for{" "}
            <span className="text-slate-700 break-words">IT Services & Tech Vendors</span>
          </h1>
          <p className="text-base sm:text-xl text-slate-600 mb-4 max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-8 mb-8 px-4">
        ...
        {/* Value Proposition */}
        <div className="mb-20">
          <Card className="metric-card rounded-2xl p-4 sm:p-10 mb-8 enterprise-shadow-lg float-animation">
            <CardContent className="p-0 flex items-center justify-center min-h-[6rem]">
              <p className="text-sm sm:text-xl text-slate-600 leading-relaxed max-w-4xl text-center px-2">
                {typewriterText}
                {!typewriterComplete && (
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
            <Card className="metric-card rounded-xl p-4 sm:p-8 group card-hover-effect" style={{ animationDelay: '0.1s' }}>
              <CardContent className="p-0">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-slate-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-slate-200 transition-colors icon-hover-rotate">
                  <Network className="h-4 w-4 sm:h-6 sm:w-6 text-slate-600" />
                </div>
                <h3 className="text-base sm:text-xl font-bold mb-3 text-slate-900 tracking-tight">
            ...
            <Card className="metric-card rounded-xl p-4 sm:p-8 group card-hover-effect" style={{ animationDelay: '0.2s' }}>
              <CardContent className="p-0">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-slate-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-slate-200 transition-colors icon-hover-rotate">
                  <Zap className="h-4 w-4 sm:h-6 sm:w-6 text-slate-600" />
                </div>
                <h3 className="text-base sm:text-xl font-bold mb-3 text-slate-900 tracking-tight">
            ...
            <Card className="metric-card rounded-xl p-4 sm:p-8 group card-hover-effect" style={{ animationDelay: '0.3s' }}>
              <CardContent className="p-0">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-slate-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-slate-200 transition-colors icon-hover-rotate">
                  <Crosshair className="h-4 w-4 sm:h-6 sm:w-6 text-slate-600" />
                </div>
                <h3 className="text-base sm:text-xl font-bold mb-3 text-slate-900 tracking-tight">
        ...
        <div className="mb-20">
          <div className="text-center mb-8">
            <h2 className="text-lg sm:text-3xl font-bold mb-3 text-slate-900 tracking-tight">
              See How It Works
            </h2>
            <p className="text-sm sm:text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto px-2">
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
            ...
            <div className="p-3 sm:p-8 space-y-4">
              {/* Company Header Card */}
              <Card className="bg-white border border-slate-200 rounded-xl p-2 sm:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 sm:w-12 sm:h-12 bg-slate-600 rounded-lg flex items-center justify-center flex-shrink-0">
                        <span className="text-white font-bold text-xs sm:text-lg">T</span>
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xs sm:text-base md:text-lg font-bold text-slate-900 mb-1 break-all">TechForward Regional Bank</h3>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                <Card className="bg-white border border-slate-200 rounded-lg p-2 sm:p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-0">
                    <div className="w-6 h-6 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-1">
                      <Cloud className="h-3 w-3 sm:h-5 sm:w-5 text-blue-600" />
                    </div>
                    <p className="text-[10px] sm:text-xs text-slate-500 mb-1">Cloud Adoption</p>
                    <p className="font-bold text-slate-900 text-xs sm:text-base">Advanced</p>
                  </CardContent>
                </Card>
                <Card className="bg-white border border-slate-200 rounded-lg p-2 sm:p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-0">
                    <div className="w-6 h-6 sm:w-10 sm:h-10 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-1">
                      <Shield className="h-3 w-3 sm:h-5 sm:w-5 text-green-600" />
                    </div>
                    <p className="text-[10px] sm:text-xs text-slate-500 mb-1">Security</p>
                    <p className="font-bold text-slate-900 text-xs sm:text-base">Moderate</p>
                  </CardContent>
                </Card>
                <Card className="bg-white border border-slate-200 rounded-lg p-2 sm:p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-0">
                    <div className="w-6 h-6 sm:w-10 sm:h-10 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-1">
                      <DollarSign className="h-3 w-3 sm:h-5 sm:w-5 text-purple-600" />
                    </div>
                    <p className="text-[10px] sm:text-xs text-slate-500 mb-1">Investment</p>
                    <p className="font-bold text-slate-900 text-xs sm:text-base">$2.5M</p>
                  </CardContent>
                </Card>
                <Card className="bg-white border border-slate-200 rounded-lg p-2 sm:p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-0">
                    <div className="w-6 h-6 sm:w-10 sm:h-10 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-1">
                      <Target className="h-3 w-3 sm:h-5 sm:w-5 text-orange-600" />
                    </div>
                    <p className="text-[10px] sm:text-xs text-slate-500 mb-1">Opportunities</p>
                    <p className="font-bold text-slate-900 text-xs sm:text-base">3</p>
                  </CardContent>
                </Card>
              </div>
                ...
                <CardContent className="p-3 sm:p-6">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-yellow-400 rounded-lg flex items-center justify-center">
                      <Zap className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-900" />
                    </div>
                    <span className="font-semibold text-sm sm:text-base">Primary Recommendation</span>
                  </div>
                  
                  <p className="text-slate-200 mb-3 leading-relaxed text-xs sm:text-sm">
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-4">
                    <div className="text-center p-2 sm:p-3 bg-slate-700 rounded-lg">
                      <p className="text-[10px] sm:text-xs text-slate-300 mb-1">Est. Value</p>
                      <p className="font-bold text-white text-xs sm:text-base">$150K-250K</p>
                    </div>
                    <div className="text-center p-2 sm:p-3 bg-slate-700 rounded-lg">
                      <p className="text-[10px] sm:text-xs text-slate-300 mb-1">Timeline</p>
                      <p className="font-bold text-white text-xs sm:text-base">3-6 months</p>
                    </div>
                    <div className="text-center p-2 sm:p-3 bg-slate-700 rounded-lg">
                      <p className="text-[10px] sm:text-xs text-slate-300 mb-1">Priority</p>
                      <p className="font-bold text-white text-xs sm:text-base">High</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
